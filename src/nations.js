...
export function getNations() {
  const nationsData = {
    ...
    5:   { era: 0, label: "EA Arcoscephale - Golden Era",
      realms: [10,3],
	   cheapgods20: [1343/*Titan of Love*/, 1230/*Forge Lord*/, 602/*Titan of Heaven*/, 600 /*Titan of War and Wisdom*/,2783/*Drakon*/, 3053 /*Grand Hierophant*/,3203/*Titan of the Hunt*/,3205/*Titan of Crossroads*/,3208/*Titan of the Spring*/,3209/*Titan of Growth*/,],
      cheapgods40: []},
    ...
    29:  { era: 0, label: "EA Ur - The First City", heat: 1,
      realms: [10,5],
      cheapgods20: [2437/*Annunaki of Growth and Rebirth*/,1373/*Annunaki of Sweet Waters*/,1372/*Annunaki of the Sky*/,2435/*Annunaki of Love and War*/,2960/*Apkallu*/,661/*Shedu*/,2137/*Urmahlullu*/,3190/*Bone Mother*/,3191/*Enkidu Great Sage*/,],
      cheapgods40: []},
    ...
    31:  { era: 0, label: "EA Xibalba - Vigil of the Sun", heat: 1,
      realms: [10,6],
	   cheapgods20: [604/*Teotl of the Night*/,2755/*Hun Came*/,2756/*Bolon-ti-ku*/,3192/*Great Camazotz*/,],
      cheapgods40: []},
    ...
    43:  { era: 1, label: "MA Arcoscephale - The Old Kingdom",
      realms: [10,3],
	   cheapgods20: [1343/*Titan of Love*/,158/*Oracle*/,1230/*Forge Lord*/, 602/*Titan of Heaven*/, 600 /*Titan of War and Wisdom*/,3053 /*Grand Hierophant*/,3203/*Titan of the Hunt*/,3205/*Titan of Crossroads*/,3208/*Titan of the Spring*/,3209/*Titan of Growth*/,],
      cheapgods40: []},
    ...
    66:  { era: 1, label: "MA Uruk - City States", heat: 1,
      realms: [10,5],
      cheapgods20: [2436/*Annunaki of the Moon*/,1374/*Annunaki of the Morning Star*/,2435/*Annunaki of Love and War*/,2960/*Apkallu*/,661/*Shedu*/,2137/*Urmahlullu*/,3190/*Bone Mother*/,3191/*Enkidu Great Sage*/,],
      cheapgods40: []},
    ...
    80:  { era: 2, label: "LA Arcoscephale - Sibylline Guidance",
      realms: [10,3,5],
      cheapgods20: [1343/*Titan of Love*/,158/*Oracle*/,602/*Titan of Heaven*/,600 /*Titan of War and Wisdom*/,3053 /*Grand Hierophant*/,3203/*Titan of the Hunt*/,3205/*Titan of Crossroads*/,3208/*Titan of the Spring*/,3209/*Titan of Growth*/,],
      cheapgods40: []},
    81:  { era: 2, label: "LA Pythium - Serpent Cult",
      realms: [10,3,7],
      cheapgods20: [1342/*Titan of Rivers*/,1371/*Titan of Death and Rebirth*/,387/*Neteret of Many Names*/,874/*Divine Emperor*/,2799/*Wadjet*/,266/*Dragon(N)*/,653/*Serpent King*/,3208/*Titan of the Spring*/,3209/*Titan of Growth*/,],
      cheapgods40: []},
    ...
    95:  { era: 2, label: "LA Midgård - Age of Men", heat: -1,
      realms: [10,1],
      cheapgods20: [1098/*Asynja*/,],
      cheapgods40: []},
    96:  { era: 2, label: "LA Utgård - Well of Urd", heat: -1,
      realms: [10,1],
      cheapgods20: [644/*Dracolich*/,643/*Bog Mummy*/,1229/*Son of Fenrer*/,500/*Skratti*/,],
      cheapgods40: []},
    ...
    99:  { era: 2, label: "LA Gath - Last of the Giants", heat: 1,
      realms: [10,5],
      cheapgods20: [1025/*Divine Glyph*/,2462/*Golden Idol*/,2083/*Son of the Fallen*/,120/*Moloch*/,],
      cheapgods40: []},
    100: { era: 2, label: "LA Ragha - Dual Kingdom",
      realms: [10,5,8],
      cheapgods20: [2610/*Angra Mainyu*/,2608/*Azi*/,2627/*Daeva of Wrath*/,2611/*Gannag Menog*/,2788/*Man-Eater*/,486/*Great Warlock*/,509/*Arch Seraph*/,],
      cheapgods40: []},
    101: { era: 2, label: "LA Xibalba - Return of the Zotz", heat: 1,
      realms: [10,6],
      cheapgods20: [604/*Teotl of the Night*/,2755/*Hun Came*/,2756/*Bolon-ti-ku*/,3192/*Great Camazotz*/,],
      cheapgods40: []},
    102: { era: 2, label: "LA Phlegra - Sleeping Giants",
      realms: [3],
      cheapgods20: [2463/*Statue of War*/,3124/*Titan of Forethough*/,3121/*Eldest Cyclops*/,],
      cheapgods40: []},
    106: { era: 2, label: "LA Atlantis - Frozen Sea", heat: -2,
      realms: [10],
      cheapgods20: [2853/*Ghost King*/,265/*Dragon(W)*/,2852/*King of Frozen Bones*/,],
      cheapgods40: []},
    107: { era: 2, label: "LA R’lyeh - Dreamlands",
      realms: [9],
      cheapgods20: [546/*Void Lurker*/,2980/*Uttervast*/,652/*Void Lord*/,2855/*Floating Mind*/,3054/*Firstborn of the Star*/,],
      cheapgods40: []},
    108: { era: 2, label: "LA Erytheia - Kingdom of Two Worlds", heat: 1,
      realms: [10,3,7,9],
      cheapgods20: [1342/*Titan of Rivers*/,2851/*Titan of Winds and Waves*/,961/*Titan of the Sea*/,2446/*Neter of Kings*/,387/*Neteret of Many Names*/,1233/*Lord of the Waves*/,1232/*Old Man of the Sea*/,2792/*Solar Serpent*/,3053 /*Grand Hierophant*/,],
      cheapgods40: [1371/*Titan of Death and Rebirth*/,]},
  };
