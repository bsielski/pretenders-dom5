export function getBlessEffects() {
  const blessData = [
    ...
    {id: 10  , f: 6, scales:{}, name: "Flaming Weapons", incarnate: true,
      shortDescription: "Fire damage (6 AP dmg)",
    },
    ...
    {id: 26  , w: 3, scales:{}, name: "Defence Skill (*)",
      shortDescription: "+2 defence",
    },
    {id: 27  , w: 4, scales: {heat: -1}, name: "Frost Weapons",
      shortDescription: "Cold damage (8 dmg)",
    },
    ...
    {id: 33  , e: 2, scales:{}, name: "Reconstruction",
      shortDescription: "Inanimate units can heal",
    },
    ...
    {id: 45  , s: 3, f: 1, scales:{}, name: "Solar Weapons",
      shortDescription: "Additional 3 AP dmg, 9 AP dmg vs undead",
    },
    ...
    {id: 59  , d: 8, scales:{}, name: "Death Weapons", incarnate: true,
      shortDescription: "additional death damage +2 and disease",
    },
    ...
    {id: 67  , n: 4, scales: {growth: -1}, name: "Poison Weapons",
      shortDescription: "additional poison damage (5 dmg)",
    },
    ...
    {id: 70  , n: 6, scales:{}, name: "Barkskin", incarnate: true,
      shortDescription: "Natural protection 10, Fire vulnerability 5",
    },
    {id: 71  , n: 7, scales:{}, name: "Regeneration", incarnate: true,
      shortDescription: "Regeneration (10%)",
    },
    ...
    {id: 76  , b: 6, scales:{}, name: "Unholy Weapons", incarnate: true,
      shortDescription: "additional unholy damage (10 AP dmg)",
    },
