export function getBlessEffects() {
  const blessData = [
    ...
    {id: 30  , w: 10, scales: {magic: 1}, name: "Quickness", incarnate: true,
      shortDescription: "number of melee attacks *2, combat speed *2, attack +2, defence +2",
    },
    ...
    {id: 37  , e: 4, n: 3, scales:{}, name: "Larger",
      shortDescription: "+1 size, + 30% HP, +3 strength, -1 defence, +2 map move",
    },
    ...
    {id: 74  , b: 4, scales:{}, name: "Blood Surge",
      shortDescription: "+3 attack, +3 strength, +1 defence, +1 reinvigoration after kill",
    },
